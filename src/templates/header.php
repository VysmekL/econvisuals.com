...
<head>
    ...
    <meta name="description" content="<?= $pageDescription ?? 'Data-driven infographics with verified sources' ?>">

    <title><?= $pageTitle ?? 'EconVisuals' ?></title>

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="<?= isset($post) ? 'article' : 'website' ?>">
    <meta property="og:url" content="https://<?= $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>">
    <meta property="og:title" content="<?= $pageTitle ?? 'EconVisuals' ?>">
    <meta property="og:description" content="<?= $pageDescription ?? 'Data-driven infographics with verified sources' ?>">
    ...
    <meta name="twitter:title" content="<?= $pageTitle ?? 'EconVisuals' ?>">
    <meta name="twitter:description" content="<?= $pageDescription ?? 'Data-driven infographics with verified sources' ?>">
    <?php if (isset($ogImage)): ?>
